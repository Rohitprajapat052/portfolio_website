  ...
  return (
    <div className="w-full bg-gray-100 text-gray-900 py-16">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        {/* Decorative Divider */}
        <div className="w-20 h-1 bg-[#FFAC1C] mx-auto mt-4"></div>
      </div>

      {/* Meet Our Team Section */}
      <div className="max-w-6xl mx-auto px-6 mt-12">
        <h2 className="text-4xl font-bold text-center text-[#FFAC1C]">Meet Our Team</h2>
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              <img
                src={member.image}
                alt={member.name}
                className="w-32 h-32 mx-auto rounded-full border-4 border-[#FFAC1C] object-cover"
              />
              <h4 className="text-2xl font-semibold text-[#FFAC1C] mt-4">{member.name}</h4>
